...
SCHEMA_PATH = Path('/Users/chaunceyplummer/Desktop/NucampFolder/6-python/hair/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = BinaryPaths.parse_obj({'queryEngine': {'darwin': '/Users/chaunceyplummer/.cache/prisma-python/binaries/4.11.0/8fde8fef4033376662cad983758335009d522acb/node_modules/prisma/query-engine-darwin'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    barber: 'actions.BarberActions[models.Barber]'
    ...
    def __init__(
        ...
        *,
        ...
        self.barber = actions.BarberActions[models.Barber](self, models.Barber)
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'postgres://gtfixtxgrbgrze:04ca58c50b220c61df03a4f4e9bcde65e3e31e596f7fcc91aa606429e3857c4a@ec2-52-54-212-232.compute-1.amazonaws.com:5432/d8pqm4p4gon5th', 'fromEnvVar': None}).resolve(),
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.barber = BarberBatchActions(self)
