...
class Appointment(bases.BaseAppointment):
    ...
    def create_partial(
        ...
        try:
            ...
            if relations:
                raise ValueError('Model: "Appointment" has no relational fields.')
...
class Barber(bases.BaseBarber):
    ...
    def create_partial(
        ...
        try:
            ...
            if relations:
                raise ValueError('Model: "Barber" has no relational fields.')
        except KeyError as exc:
            raise ValueError(
...
class Transaction(bases.BaseTransaction):
    ...
    def create_partial(
        ...
        try:
            ...
            if relations:
                raise ValueError('Model: "Transaction" has no relational fields.')
        except KeyError as exc:
            raise ValueError(
...
class Contact(bases.BaseContact):
    ...
    def create_partial(
        ...
        try:
            ...
            if relations:
                raise ValueError('Model: "Contact" has no relational fields.')
        except KeyError as exc:
            raise ValueError(
...
_Appointment_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
...
_Barber_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
...
_Transaction_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
...
_Contact_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
