...
class TransactionActions(Generic[_PrismaModelT]):
    ...
    def create(
        ...
        transaction = Transaction.prisma().create(
            data={
                ...
                'fcustomerId': 'ggciceaie',
                'orderPrice': 1147902781,
                'fbarberId': 2035015474,
            },
        )
        ```
        """
        ...
        *,
        ...
        total = Transaction.prisma().create_many(
            data=[
                {
                    # data to create a Transaction record
                    'fcustomerId': 'dgiiaaijj',
                    'orderPrice': 1508029952,
                    'fbarberId': 486256185,
                },
                {
                    # data to create a Transaction record
                    'fcustomerId': 'bagcfbhiig',
                    'orderPrice': 267834847,
                    'fbarberId': 180171308,
                },
            ],
    ...
    def group_by(
        self,
        by: List['types.TransactionScalarFieldKeysT'],
        *,
        where: Optional['types.TransactionWhereInput'] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        ...
        order: Optional[Union[Mapping['types.TransactionScalarFieldKeysT', 'types.SortOrder'], List[Mapping['types.TransactionScalarFieldKeysT', 'types.SortOrder']]]] = None,
        ...
        -------
        ```py
        # group Transaction records by fbarberId values
...
class BarberActions(Generic[_PrismaModelT]):
    ...
    def group_by(
        self,
        by: List['types.BarberScalarFieldKeysT'],
        *,
        where: Optional['types.BarberWhereInput'] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        ...
        order: Optional[Union[Mapping['types.BarberScalarFieldKeysT', 'types.SortOrder'], List[Mapping['types.BarberScalarFieldKeysT', 'types.SortOrder']]]] = None,
...
class CustomerActions(Generic[_PrismaModelT]):
    ...
    def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Customer records by firstName values
        # and count how many records are in each group
...
class AppointmentActions(Generic[_PrismaModelT]):
    ...
    def create(
        ...
        appointment = Appointment.prisma().create(
            data={
                ...
                'fcustomerId': 'ihieecagf',
                'appointmentDate': datetime.datetime.utcnow(),
                'fbarberId': 1675280054,
            },
        )
        ```
        """
        ...
        *,
        ...
        total = Appointment.prisma().create_many(
            data=[
                {
                    # data to create a Appointment record
                    'fcustomerId': 'bgchfhgceh',
                    'appointmentDate': datetime.datetime.utcnow(),
                    'fbarberId': 2054802212,
                },
                {
                    # data to create a Appointment record
                    'fcustomerId': 'gaddfhfh',
                    'appointmentDate': datetime.datetime.utcnow(),
                    'fbarberId': 684462146,
                },
            ],
    ...
    def find_many(
        ...
        # find the first 5 Appointment records ordered by the Date field
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second Appointment record ordered by the appointmentDate field
    ...
    def group_by(
        self,
        by: List['types.AppointmentScalarFieldKeysT'],
        *,
        where: Optional['types.AppointmentWhereInput'] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        ...
        order: Optional[Union[Mapping['types.AppointmentScalarFieldKeysT', 'types.SortOrder'], List[Mapping['types.AppointmentScalarFieldKeysT', 'types.SortOrder']]]] = None,
        ...
        -------
        ```py
        # group Appointment records by Date values
        # and count how many records are in each group
