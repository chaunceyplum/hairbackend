...
class AppointmentActions(Generic[_PrismaModelT]):
    ...
    async def query_raw(
        ...
        *args
        ...
        -------
        ```py
        users = await Appointment.prisma().query_raw(
    ...
    async def query_first(
        ...
        *args
        ...
        -------
        ```py
        user = await Appointment.prisma().query_first(
    ...
    async def create(
        ...
        appointment = await Appointment.prisma().create(
            data={
    ...
    async def create_many(
        ...
        *,
        ...
        -------
        ```py
        total = await Appointment.prisma().create_many(
            data=[
                {
                    # data to create a Appointment record
    ...
    async def delete(
        ...
        -------
        ```py
        appointment = await Appointment.prisma().delete(
            where={
    ...
    async def find_unique(
        ...
        -------
        ```py
        appointment = await Appointment.prisma().find_unique(
            where={
    ...
    async def find_many(
        ...
        appointments = await Appointment.prisma().find_many(take=10)

        # find the first 5 Appointment records ordered by the fbarberId field
        appointments = await Appointment.prisma().find_many(
            take=5,
            order={
                'fbarberId': 'desc',
            },
    ...
    async def find_first(
        ...
        appointment = await Appointment.prisma().find_first(
            skip=1,
            order={
                'Date': 'desc',
            },
    ...
    async def update(
        ...
        -------
        ```py
        appointment = await Appointment.prisma().update(
            where={
    ...
    async def upsert(
        ...
        -------
        ```py
        appointment = await Appointment.prisma().upsert(
            where={
    ...
    async def update_many(
        ...
        total = await Appointment.prisma().update_many(
            data={
                'appointmentDate': datetime.datetime.utcnow()
            },
            where={}
    ...
    async def count(
        ...
        ```py
        # total: int
        total = await Appointment.prisma().count()

        # results: prisma.types.AppointmentCountAggregateOutput
        results = await Appointment.prisma().count(
            select={
                '_all': True,
                'phoneNumber': True,
            },
    ...
    async def delete_many(
        ...
        total = await Appointment.prisma().delete_many()
        ```
        """
        resp = await self._client._execute(
            operation='mutation',
    ...
    async def group_by(
        ...
        *,
        ...
        results = await Appointment.prisma().group_by(
            ['fcustomerId'],
            count=True,
        )
        ```
...
class BarberActions(Generic[_PrismaModelT]):
    ...
    async def query_raw(
        ...
        *args
        ...
        -------
        ```py
        users = await Barber.prisma().query_raw(
    ...
    async def query_first(
        ...
        *args
        ...
        -------
        ```py
        user = await Barber.prisma().query_first(
    ...
    async def create(
        ...
        barber = await Barber.prisma().create(
            data={
    ...
    async def create_many(
        ...
        *,
        ...
        -------
        ```py
        total = await Barber.prisma().create_many(
            data=[
                {
                    # data to create a Barber record
    ...
    async def delete(
        ...
        -------
        ```py
        barber = await Barber.prisma().delete(
            where={
                'barberId': 1767274722,
            },
        )
    ...
    async def find_unique(
        ...
        -------
        ```py
        barber = await Barber.prisma().find_unique(
            where={
                'barberId': 326272115,
            },
        )
    ...
    async def find_many(
        ...
        barbers = await Barber.prisma().find_many(take=10)
    ...
    async def find_first(
        ...
        barber = await Barber.prisma().find_first(
            skip=1,
            order={
                'firstName': 'desc',
            },
    ...
    async def update(
        ...
        -------
        ```py
        barber = await Barber.prisma().update(
            where={
                'barberId': 1343201072,
            },
            data={
    ...
    async def upsert(
        ...
        -------
        ```py
        barber = await Barber.prisma().upsert(
            where={
                'barberId': 675780521,
            },
            data={
    ...
    async def update_many(
        ...
        total = await Barber.prisma().update_many(
            data={
                'barberId': 744964398
            },
            where={}
    ...
    async def count(
        ...
        ```py
        # total: int
        total = await Barber.prisma().count()

        # results: prisma.types.BarberCountAggregateOutput
        results = await Barber.prisma().count(
            select={
                '_all': True,
                'firstName': True,
            },
    ...
    async def delete_many(
        ...
        total = await Barber.prisma().delete_many()
        ```
        """
        resp = await self._client._execute(
            operation='mutation',
    ...
    async def group_by(
        ...
        *,
        ...
        # and count how many records are in each group
        results = await Barber.prisma().group_by(
            ['firstName'],
            count=True,
        )
        ```
        ...
        *,
        ...
        total = await Customer.prisma().create_many(
            data=[
                {
                    # data to create a Customer record
                    'firstName': 'beeifcbebf',
                    'lastName': 'bgcigfahea',
                    'city': 'bcejgaggif',
                    'phoneNumber': 'idfjadbcc',
                    'email': 'hgdhbjhhj',
                    'password': 'ecjjjfbae',
                },
                {
    ...
    async def create(
        ...
        transaction = await Transaction.prisma().create(
            data={
                ...
                'fcustomerId': 684462146,
                'orderPrice': 1625503827,
                'fbarberId': 521827728,
            },
        )
        ```
        ...
        *,
        ...
        total = await Transaction.prisma().create_many(
            data=[
                {
                    # data to create a Transaction record
                    'fcustomerId': 1266032265,
                    'orderPrice': 93253262,
                    'fbarberId': 2053047983,
                },
                {
                    # data to create a Transaction record
                    'fcustomerId': 685333180,
                    'orderPrice': 127474245,
                    'fbarberId': 948921754,
                },
            ],
            skip_duplicates=True,
