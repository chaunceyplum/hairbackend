...
class TransactionActions(Generic[_PrismaModelT]):
    ...
    def query_first(
        ...
        *args
        ...
        user = Transaction.prisma().query_first(
            'SELECT * FROM Transaction WHERE fbarberId = $1',
            377401575,
        )
        ```
        """
    ...
    def create(
        ...
        transaction = Transaction.prisma().create(
            data={
                ...
                'fbarberId': 662824084,
                'fcustomerId': 'bbehjachib',
                'dateOfOrder': datetime.datetime.utcnow(),
                'orderPrice': 2035015474.36880,
            },
        )
        ```
        """
            ...
            data=[
                {
                    ...
                    'fcustomerId': 'eigcfgbif',
                    'dateOfOrder': datetime.datetime.utcnow(),
                    'orderPrice': 1062517886.26783,
                },
                {
                    # data to create a Transaction record
                    'fbarberId': 180171308,
                    'fcustomerId': 'idghgaicb',
                    'dateOfOrder': datetime.datetime.utcnow(),
                    'orderPrice': 595337866.79042,
                },
            ],
    ...
    def find_many(
        ...
        # find the first 5 Transaction records ordered by the fcustomerId field
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second Transaction record ordered by the dateOfOrder field
    ...
    def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Transaction records by fcustomerId values
            ...
            data=[
                {
                    ...
                    'lastName': 'ecjjjfbae',
                    'city': 'bhhfibbigf',
                    'phoneNumber': 'ijdbeffgg',
                    'ffavoriteBarber': 995405759,
                },
                {
                    # data to create a Customer record
                    'firstName': 'cbachdgfce',
                    'lastName': 'chbfcacbd',
                    'city': 'efggddide',
                    'phoneNumber': 'caficfigfb',
                    'ffavoriteBarber': 1583689592,
                },
            ],
            skip_duplicates=True,
        )
...
class AppointmentActions(Generic[_PrismaModelT]):
    ...
    def query_raw(
        ...
        *args
        ...
        users = Appointment.prisma().query_raw(
            'SELECT * FROM Appointment WHERE appointmentDate = $1',
    ...
    def create(
        ...
        appointment = Appointment.prisma().create(
            data={
                ...
                'fcustomerId': 'gieegcbeg',
                'fbarberId': 1625503827,
            },
        )
        ```
        """
            ...
            data=[
                {
                    ...
                    'appointmentDate': datetime.datetime.utcnow(),
                    'Date': datetime.datetime.utcnow(),
                    'fcustomerId': 'fcbichhci',
                    'fbarberId': 1266032265,
                },
                {
                    # data to create a Appointment record
                    'appointmentDate': datetime.datetime.utcnow(),
                    'Date': datetime.datetime.utcnow(),
                    'fcustomerId': 'jdcfdcgc',
    ...
    def find_many(
        ...
        # find the first 5 Appointment records ordered by the fcustomerId field
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second Appointment record ordered by the fbarberId field
