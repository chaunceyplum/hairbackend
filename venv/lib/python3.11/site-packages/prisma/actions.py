...
class TransactionActions(Generic[_PrismaModelT]):
    ...
    def query_first(
        ...
        *args
        ...
        user = Transaction.prisma().query_first(
            'SELECT * FROM Transaction WHERE fappointmentId = $1',
            948921754,
        )
        ```
        """
    ...
    def create(
        ...
        transaction = Transaction.prisma().create(
            data={
                ...
                'fappointmentId': 1964990155,
                'fcustomerId': 1228891816,
                'orderPrice': 255202753,
                'fbarberId': 1223573862,
            },
        )
        ```
        """
        ...
        *,
        ...
        total = Transaction.prisma().create_many(
            data=[
                {
                    # data to create a Transaction record
                    'fappointmentId': 541269159,
                    'fcustomerId': 1064846676,
                    'orderPrice': 508382461,
                    'fbarberId': 1024265714,
                },
                {
                    # data to create a Transaction record
                    'fappointmentId': 872078403,
                    'fcustomerId': 1874748096,
                    'orderPrice': 916896761,
                    'fbarberId': 769267518,
                },
            ],
            skip_duplicates=True,
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second Transaction record ordered by the orderPrice field
    ...
    def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Transaction records by fappointmentId values
        # and count how many records are in each group
